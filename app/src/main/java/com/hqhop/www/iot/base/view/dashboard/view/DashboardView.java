package com.hqhop.www.iot.base.view.dashboard.view;
...
import com.hqhop.www.iot.base.view.dashboard.Interpolator.SpringInterpolator;
import com.hqhop.www.iot.base.view.dashboard.util.PxUtils;
import com.hqhop.www.iot.base.view.dashboard.util.StringUtil;
...
//        speed = StringUtil.floatFormat(startNum + (maxNum - startNum) * percent) + unit;
        speed = StringUtil.floatFormat((maxNum - startNum) * percent) + unit;
...
//        canvas.drawCircle(0, 0, mWidth / 2 - 2, paintOutCircle);
    ...
    public void setTikeStrArray(CharSequence[] strArray) {
        this.tikeStrArray = strArray;
        invalidate();
    }
